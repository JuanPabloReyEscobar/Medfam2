...
from inventory.forms import UserRegistry, ProductForm, OrderForm, InventarioForm
from inventory.models import Product, Order, Inventario
...
def index(request):
    ...
    all_inventario = len(Inventario.objects.all())
...
def products(request):
    ...
    if request.method == "POST":
        ...
        form = InventarioForm()
    context = {"title": "Inventario", "inventario_items": inventario_items, "form": form}
